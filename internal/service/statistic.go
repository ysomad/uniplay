...
// func (s *statistic) GetWeaponStats(ctx context.Context, steamID uint64, f domain.WeaponStatsFilter) (map[uint16]domain.PlayerWeaponStats, error) {
...
// 	var (
// 		weaponStats = make(map[uint16]domain.PlayerWeaponStats)
...
// 		stats := domain.PlayerWeaponStats{
// 			WeaponID:      m.WeaponID,
// 			Weapon:        m.Weapon,
