...
// ContextValidate validate this player weapon stats based on the context it is used
func (m PlayerWeaponStats) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
