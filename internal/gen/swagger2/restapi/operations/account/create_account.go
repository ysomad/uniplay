...
type CreateAccountHandlerFunc func(CreateAccountParams) CreateAccountResponder

// Handle executing the request and returning a response
func (fn CreateAccountHandlerFunc) Handle(params CreateAccountParams) CreateAccountResponder {
	return fn(params)
}

// CreateAccountHandler interface for that can handle valid create account params
type CreateAccountHandler interface {
	Handle(CreateAccountParams) CreateAccountResponder
}
...
/*
	CreateAccount swagger:route POST /accounts account createAccount
